...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\General Use\\Desktop\\N-Back-master\\ColourTesting.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    if thisBlock1_1back != None:
        for paramName in thisBlock1_1back:
            globals()[paramName] = thisBlock1_1back[paramName]
    ...
    for thisBlock1_1back in Block1_1back:
        ...
        if key_resp_3.keys != None:  # we had a response
            ...
            Block1_1back.addData('key_resp_3.duration', key_resp_3.duration)
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
    ...
    if thisBlock3_3back != None:
        for paramName in thisBlock3_3back:
            globals()[paramName] = thisBlock3_3back[paramName]
    ...
    for thisBlock3_3back in Block3_3back:
        ...
        if key_resp_3.keys != None:  # we had a response
            ...
            Block3_3back.addData('key_resp_3.duration', key_resp_3.duration)
        # using non-slip timing so subtract the expected duration of this Routine (unless ended on request)
        if routineForceEnded:
            routineTimer.reset()
        else:
